...
export const TaskProvider = ({children}) => {
    ...
    const [setAtualizar] = useState(0);   // Cria um estado para forçar atualização do componente

    const atualizar = () => setAtualizar(setAtualizar + 1);  // Função para atualizar o estado e forçar re-render
